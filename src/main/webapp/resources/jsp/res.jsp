...
<script type="text/javascript" src="${ctx}/resources/scripts/jquery.rest.min.js"></script>
...
<script type="text/javascript" src="${ctx}/resources/scripts/jqgrid/jquery.jqGrid.js"></script>
<script type="text/javascript" src="${ctx}/resources/scripts/jqgrid/grid.locale-cn.js"></script>
<!-- This is the localization file of the grid controlling messages, labels, etc.
<!-- A link to a jQuery UI ThemeRoller theme, more than 22 built-in and many more custom -->
<link rel="stylesheet" href="${ctx}/resources/styles/boostrape/css/bootstrap.css">
<!-- The link to the CSS that the grid needs -->
<link rel="stylesheet" type="text/css" media="screen" href="${ctx}/resources/styles/jqgrid/ui.jqgrid-bootstrap.css"/>
<script>
