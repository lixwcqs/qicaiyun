...
//module begin
	$.fmatter = {};
	//opts can be id:row id for the row, rowdata:the data for the row, colmodel:the column modules for this column
	//example {id:1234,}
	$.extend($.fmatter,{
	...
	$.fn.fmatter.rowactions = function(act) {
		...
		if (cm.formatoptions !== undefined) {
			...
			// Otherwise, the assignment of op.extraparam[p.prmNames.oper] below may persist into the colModel com.cqs.config.
